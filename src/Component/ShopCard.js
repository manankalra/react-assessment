...
import { Card, CardImg, CardTitle, CardSubtitle, CardBody, Input, Button, Collapse, InputGroup, InputGroupAddon } from 'reactstrap';
            ...
            <Collapse id={"ShopCardCollapse" + product._id} isOpen={this.state.collapse}>
              <InputGroup id={"ShopCardInputGroup" + product._id}>
                  ...
                  <InputGroupAddon id={"ShopCardInputGroupAddOn" + product._id} addonType="append">
                      <Button id={"ShopCardButton" + product._id} size="md" color="info" onClick={() => this.props.addProduct(product, this.func(product._id))}>Add</Button>
                  </InputGroupAddon>
              </InputGroup>
            </Collapse>
        </Card>
